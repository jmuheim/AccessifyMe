...
# Generation Time: 2023-01-29 13:27:35 +0000
# ************************************************************
...
CREATE TABLE `virtues` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `short_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `abbr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `virtues` (`id`, `name`, `short_name`, `abbr`, `intent`, `description`, `notes`, `image`, `inspires_design`, `inspires_development`, `inspires_writing`, `inspires_multimedia`, `created_at`, `updated_at`)
VALUES
	(1,'Offer good color contrast','Color contrast','CNT','We colorize content so that it stands out clearly against the background.','Many users have difficulty perceiving color nuances. For them, a light gray text on a white background may not be visible at all. Similarly, inside a form, a text input with a light gray border on a white background will hardly be recognised as an input.','# Thoughts\n\n- With \"content\" we do not only mean text etc., but also visual attributes that have meaning (i.e. the underline of a link)!\n\n# Further information\n\n- https://www.w3.org/WAI/test-evaluate/preliminary/#contrast\n- https://webaim.org/articles/contrast/\n- https://accessibility.blog.gov.uk/2016/06/17/colour-contrast-why-does-it-matter/\n- https://design-system.service.gov.uk/styles/colour/\n- https://accessibility.blog.gov.uk/2017/03/27/how-users-change-colours-on-websites/',NULL,1,1,0,1,'2022-09-27 21:58:34.000000','2022-09-27 21:58:34.000000'),
	(2,'Complement meaningful colors with visual cues','Meaningful color','COL','When color carries meaning, we add a visual cue like a label, icon, or pattern.',NULL,'Bezug auf sensorische Merkmale, siehe https://ergebnis.bitvtest.de/pruefschritt/bitv-20-web/9-1-3-3-ohne-bezug-auf-sensorische-merkmale-nutzbar\n\nhttps://ergebnis.bitvtest.de/pruefschritt/bitv-20-web/9-1-4-1-ohne-farben-nutzbar\n\nWhat about 2-sense principle? → Maybe we just stick to the Pareto-rule (we cannot take into account each and everything)\n\nhttps://colorblindaccessibilitymanifesto.com/',NULL,1,1,0,1,'2022-09-27 21:58:34.000000','2022-09-27 21:58:34.000000'),
	(3,'Describe graphics through text alternatives','Text alternatives','ALT','We implement graphical elements correctly and provide meaningful text alternatives.',NULL,NULL,NULL,1,1,1,1,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(4,'Provide accessible audio and video','Audio & video','AVO','We add text transcripts to audio and closed captioning (CC) to video.',NULL,NULL,NULL,1,1,0,1,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(5,'Ensure keyboard-only operability','Keyboard-only','KBD','We make sure that websites can be operated by keyboard alone (without mouse).',NULL,'Alternative für komplexe Zeigergesten: https://ergebnis.bitvtest.de/pruefschritt/bitv-20-web/9-2-5-1-alternativen-fuer-komplexe-zeiger-gesten\n\nZeigergesten-Eingaben können abgebrochen oder widerrufen werden: https://ergebnis.bitvtest.de/pruefschritt/bitv-20-web/9-2-5-2-zeigergesten-eingaben-koennen-abgebrochen-oder-widerrufen-werden\n\nKeine unvorhergesehene Kontext-Veränderung','keyboard-only',1,1,0,0,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(6,'Apply semantics to structure content (HTML 101)','Semantics','SMN','We mark up content with inherent meaning through semantics.',NULL,'Meaningful pieces of info: Ansich alles, was mit korrektem Markup zu tun hat!\n\nAdditional labeling mechanisms: title, aria-label, ggf. auch Formuar-Labels (?), etc.\n\nDocument structure (header, main, footer...) vs. content structure (section, article...)\n\nListen, Zitate\n\nSinnvolle Reihenfolge\n\nAussagekräftige Link/Button-Texte\n\nSprache, Sprache von Teilen',NULL,1,1,0,0,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(7,'Define a coherent page structure and headings','Structure & headings','HDG','We organise a page into meaningful parts with a coherent heading hierarchy.',NULL,'',NULL,1,1,0,0,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(8,'Mark up tabular data as tables','Tables','TBL','We implement solid tables with proper headers.',NULL,NULL,NULL,1,1,0,0,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(9,'Build robust forms and validations','Forms & validations','FRM','We implement solid forms and provide meaningful instruction and validation mechanisms.',NULL,'autocomplete-Attribut!\n\nSichtbare Beschriftung Teil des zugänglichen Namens: https://ergebnis.bitvtest.de/pruefschritt/bitv-20-web/9-2-5-3-sichtbare-beschriftung-teil-des-zugaenglichen-namens → oder besser zu Keyboard-only?\n\nAuf Verknüpftheit einiger Elemente hinweisen, z.B. dass LEGEND angesagt wird beim Hineinspringen in ein FIELDSET',NULL,1,1,0,0,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(10,'Optimise screen reader compatibility','Screen reader','SCR','We validate that screen readers can understand, navigate, and interact with the website.',NULL,'aria-current, invisible content, alerts, page title?\n\n→ Unsicher, ob das vor oder nach \"Information structure and headings\" kommen soll. Einerseits wird es zum Sicherstellen davon benötigt, andererseits sind aria-current, invisible content, alerts etc. bereits \"advanced\" Knowledge',NULL,1,1,0,0,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(11,'Choose accessible web components','Components','CMP','We make sure that third party web components are fully accessible.',NULL,'Soll da auch sensilbe ARIA usage rein? Oder bei SR operability?',NULL,1,1,0,0,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(12,'Build a robust yet flexible experience','Robust & flexible','RBF','We write code that is as strict as necessary, yet as interpretable and adaptable as possible.',NULL,'Kein ungültiger Code, keine unnötigen Einschränkungen für z.B. User Styles oder Hoch- vs. Querformat\n\nSession timeouts\n\nCaptchas\n\nPausieren, beenden, ausblenden?\n\nTon abschaltbar\n\nText vergrösserbar\n\nText Reflow, keine Überlappungen\n\nKein Flackern\n\nResponsive',NULL,1,1,0,0,'2022-09-27 23:39:32.000000','2022-09-27 23:39:32.000000');
