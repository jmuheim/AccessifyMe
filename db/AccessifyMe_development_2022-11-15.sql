...
# Generation Time: 2022-11-15 14:09:23 +0000
# ************************************************************
...
VALUES
	...
	(3,'dont',1,'Interactive element implemented as `<span>`, `<div>`, etc.','Non-interactive HTML elements can\'t be focused by default. While you can add focusability with `tabindex=\"0\"`, you should avoid it.','Die typischen Verdächtigen: können nicht fokusiert werden (ausser mit der `tabindex`-Krücke)\n\nFail: Twitter-Signup: \"Use email/phone instead\" funktioniert kann mit Tastatur nicht aktiviert werden.','0000-00-00 00:00:00.000000','0000-00-00 00:00:00.000000'),
	(4,'dont',1,'Link implemented as `<button>`','A button can never be a proper link, period. Instead, use CSS to make a link look like a button.','Wenn ein Link wie ein Button aussehen soll → besser CSS Klasse `.button` verwenden!','0000-00-00 00:00:00.000000','0000-00-00 00:00:00.000000'),
...
VALUES
	(1,4,'Interactive elements should be focusable','Focusable','This enables keyboard-only users to reach all functionalities.',NULL,'2022-08-24 15:43:18.000000','2022-08-24 15:43:18.000000'),
	(2,4,'Interactive elements should be fully operable via keyboard alone','Operable','This enables keyboard-only users to operate all functionalities.',NULL,'2022-08-24 15:53:43.000000','2022-08-24 15:53:43.000000'),
	(3,4,'Focus states of interactive elements should be clearly visible','Focus visible','This enables keyboard-only users to identify the currently focused element.',NULL,'2022-08-24 15:57:42.000000','2022-08-24 15:57:42.000000'),
	(4,4,'States of interactive elements should be easily distinguishable','States distinguishable','This enables keyboard-only users to distinguish between different statuses of an element and interact accordingly with it.','Ist das überhaupt sinnvoll platziert hier? Hat ja nicht unbedingt nur was mit Keyboard zu tun...!','2022-08-24 16:00:52.000000','2022-08-24 16:00:52.000000'),
	(5,4,'Sequence of interactive elements should be meaningful','Sequence meaningful','This enables keyboard-only users to intuitively locate and interact with elements.',NULL,'0000-00-00 00:00:00.000000','0000-00-00 00:00:00.000000');
...
VALUES
	(1,'Enough contrast','Contrast','We colorize content so that it stands out clearly against the background.',NULL,NULL,1,1,0,1,'2022-09-27 21:58:34.000000','2022-09-27 21:58:34.000000'),
	(2,'Color usage','Color','When color carries meaning, we apply an additional feature like shape or pattern.','Bezug auf sensorische Merkmale, siehe https://ergebnis.bitvtest.de/pruefschritt/bitv-20-web/9-1-3-3-ohne-bezug-auf-sensorische-merkmale-nutzbar\n\nhttps://ergebnis.bitvtest.de/pruefschritt/bitv-20-web/9-1-4-1-ohne-farben-nutzbar\n\nWhat about 2-sense principle? → Maybe we just stick to the Pareto-rule (we cannot take into account each and everything)\n\nhttps://colorblindaccessibilitymanifesto.com/',NULL,1,1,0,1,'2022-09-27 21:58:34.000000','2022-09-27 21:58:34.000000'),
	(3,'Comprehensible content','Comprehensible','We produce content (text, audio, and video) so that it is easy to understand.','Was ist mit der Lesbarkeit von Schriftarten? https://medium.com/the-readability-group/a-guide-to-understanding-what-makes-a-typeface-accessible-and-how-to-make-informed-decisions-9e5c0b9040a0',NULL,0,0,1,1,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(4,'Keyboard-only operability','Keyboard','We ensure that websites can be operated by keyboard alone.','Alternative für komplexe Zeigergesten: https://ergebnis.bitvtest.de/pruefschritt/bitv-20-web/9-2-5-1-alternativen-fuer-komplexe-zeiger-gesten\n\nZeigergesten-Eingaben können abgebrochen oder widerrufen werden: https://ergebnis.bitvtest.de/pruefschritt/bitv-20-web/9-2-5-2-zeigergesten-eingaben-koennen-abgebrochen-oder-widerrufen-werden\n\nKeine unvorhergesehene Kontext-Veränderung','keyboard-only',1,1,0,0,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(5,'Images, icons, and text alternatives','Images','We implement pictorial information correctly and provide meaningful text alternatives.',NULL,NULL,1,1,1,1,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(6,'Semantics, information structure, and headings','Semantics','We organise documents into meaningful pieces of content and apply proper headings.','Meaningful pieces of info: Ansich alles, was mit korrektem Markup zu tun hat!\n\nAdditional labeling mechanisms: title, aria-label, ggf. auch Formuar-Labels (?), etc.\n\nDocument structure (header, main, footer...) vs. content structure (section, article...)\n\nÜberschriften, Listen, Zitate, Tabellen\n\nSinnvolle Reihenfolge\n\nAussagekräftige Link/Button-Texte\n\nSprache, Sprache von Teilen',NULL,1,1,0,0,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(7,'Screen reader compatibility','Screen reader','We ensure that websites can be fully understood and navigated with screen readers.','aria-current, invisible content, alerts?\n\n→ Unsicher, ob das vor oder nach \"Information structure and headings\" kommen soll. Einerseits wird es zum Sicherstellen davon benötigt, andererseits sind aria-current, invidsible content, alerts etc. bereits \"advanced\" Knowledge',NULL,1,1,0,0,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
	(8,'Forms and validations','Forms','We implement solid forms and provide meaningful validation mechanisms.','autocomplete-Attribut!\n\nSichtbare Beschriftung Teil des zugänglichen Namens: https://ergebnis.bitvtest.de/pruefschritt/bitv-20-web/9-2-5-3-sichtbare-beschriftung-teil-des-zugaenglichen-namens → oder besser zu Keyboard-only?\n\nAuf Verknüpftheit einiger Elemente hinweisen, z.B. dass LEGEND angesagt wird beim Hineinspringen in ein FIELDSET',NULL,1,1,0,0,'2022-09-27 22:40:07.000000','2022-09-27 22:40:07.000000'),
