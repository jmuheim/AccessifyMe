...
## 🙏 I - Offer sufficient color contrast
...
## 🙏 II - Complement meaningful color with visual cues
...
## 🙏 III - Describe graphics through alternative text
...
## 🙏 IV - Provide audio transcripts and video subtitles
...
## 🙏 V - Ensure keyboard-only operability
...
- 💡 (Why) **Focused interactive elements must clearly stand out** → 🤔 *different focus states for keyboard and mouse? (Luis Argüello hatte da eine kleine Library)* → vielleicht später verschieben in Tugend "Contrast"? Würde diese hier etwas verkleinern (ist die mit Abstand umfangreichste Tugend).
  ...
  - 🧩 Skip links appear on focus → 🤔 *Verweis auf  Concept "Hiding elements properly"*
    ...
    - 🚀 WCAG 2.2, 2.4.12 (https://www.w3.org/TR/WCAG22/#focus-not-obscured-minimum): Focus Not Obscured (Minimum)
...
## 🙏 VI - Apply semantics to structure content (HTML 101)

→ Concept "Semantics" → Natürlich stützen sich einige vorangehende Tugenden auch auf Semantik, deshalb klar gegenseitig referenzieren!
...
## 🙏 VII - Define a coherent page structure and headings
...
- 💡 (Why) **Each page should have a unique and descriptive title**
  - 🧩 A typical website's `<title>`s
...
## 🙏 VIII - Mark up tabular data as tables
...
## 🙏 IX - Build robust forms and validations
...
## 🙏 X - Optimise screen reader compatibility
...
## 🙏 XI - Choose accessible web components
...
## 🙏 XII - Build a robust yet flexible experience
