class RequirementsController < ApplicationController
  ...
  private
    ...
    def set_requirement
      ...
      redirect_to @requirement if params[:id] =~ /^\d+$/ # Redirect to slugged URL if only ID was provided, i.e. requirements/123 => videos/123-interactive-elements-must-be-focusable
    end

    # Only allow a list of trusted parameters through.
    def requirement_params
      params.require(:requirement).permit(:video_id, :title, :description)
    end
end
