class ToolsController < ApplicationController
  ...
  private
    ...
    def set_tool
      ...
      redirect_to @tool if params[:id] =~ /^\d+$/ # Redirect to slugged URL if only ID was provided, i.e. tools/123 => videos/123-desktop-browser
    end

    # Only allow a list of trusted parameters through.
    def tool_params
      params.require(:tool).permit(:name, :icon, :description)
    end
end
