...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference("Requirement.count") do
      post requirements_url, params: { requirement: { description: @requirement.description, title: @requirement.title, video_id: @requirement.video_id } }
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { description: @requirement.description, title: @requirement.title, video_id: @requirement.video_id } }
